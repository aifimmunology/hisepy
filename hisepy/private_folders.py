...
def validate_upload_private_folder_params(file_path: str = None,
    ...
    if destination is not None:
        assert ~cu.string_contains_whitespaces(
            destination
        ), "white space detected in destination parameter. Please remove all whitespaces"
    return
...
def upload_file_to_private_folder(file_path: str = None,
    ...
    Returns: 
        Response object
    '''
    validate_upload_private_folder_params(file_path, folder_name,
