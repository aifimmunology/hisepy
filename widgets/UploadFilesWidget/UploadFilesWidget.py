...
class UploadFilesWidget:
    min_title_length = 10
    study_space_dropdown_place_holder = 'Choose a Study space'
    study_space_dropdown_description = 'Study space:'

    title_text_placeholder = 'Type a title for the uploaded files'
    title_text_description = 'Title:'
    
    description_text_placeholder = 'Type a description for the uploaded files'
    ...
    save_button_tooltip = 'Upload files'
    save_button_description = 'Save'
    save_button_label = 'Save to study space:'
    
    heading_text = 'Upload files to Study Space'
    
    def __init__(self):
        self.upload_files_result = None
        
        self.heading_text = widgets.HTML(
            value="<h1>" + UploadFilesWidget.heading_text + "</h1>",
        )
        ...
        self.study_space_dropdown = widgets.Dropdown(
            placeholder=UploadFilesWidget.study_space_dropdown_place_holder,
            options=self.sp_options,
            # description=UploadFilesWidget.study_space_dropdown_description,
        )

        self.title_text = widgets.Text(
            value='',
            placeholder=UploadFilesWidget.title_text_placeholder,
            disabled=False
        )

        self.description_text = widgets.Text(
            value='',
            placeholder=UploadFilesWidget.description_text_placeholder,
            disabled=False
        )
        ...
        self.input_file_ids = widgets.Text(
                            placeholder=UploadFilesWidget.input_file_ids_placeholder,
                            disabled=False
                        )
        
        self.input_sample_ids = widgets.Text(
                            placeholder=UploadFilesWidget.input_sample_ids_placeholder,
                            disabled=False
                        )
        
        self.save_button = widgets.Button(
            description=UploadFilesWidget.save_button_description,
            disabled=False,
        ...
        # app specific info
        self.grid[1, 0] = widgets.Label(UploadFilesWidget.study_space_dropdown_description)
        self.grid[1, 1] = self.study_space_dropdown
        self.grid[1, 2] = widgets.Label(UploadFilesWidget.title_text_description)
        self.grid[1, 3] = self.title_text

        # app files
        self.grid[2, 0] = widgets.Label(UploadFilesWidget.additional_files_description)
        self.grid[2, 1] = self.additional_files
        
        # file or sample ids
        self.grid[3, 0] = widgets.Label(UploadFilesWidget.input_file_ids_description)
        self.grid[3, 1] = self.input_file_ids
        self.grid[3, 2] = widgets.Label(UploadFilesWidget.input_sample_ids_description)
    ...
    def getUploadFilesResult(self):
        return self.upload_files_result
